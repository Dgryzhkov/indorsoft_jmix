package com.company.indorsoftjmix.test_support

import com.company.indorsoftjmix.IndorsoftjmixApplication
...
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = ["com.company.indorsoftjmix.screen"])
@ContextConfiguration(classes = [IndorsoftjmixApplication::class, UiTestAssistConfiguration::class])
